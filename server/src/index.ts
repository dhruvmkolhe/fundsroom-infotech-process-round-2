...
// CORS: allow localhost in dev + the deployed Vercel frontend in production.
// Set CORS_ORIGIN=https://fundsroom-infotech-process-round-2.vercel.app in Railway env vars.
